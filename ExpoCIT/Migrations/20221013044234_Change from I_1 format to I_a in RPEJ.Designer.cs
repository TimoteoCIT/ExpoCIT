...
namespace ExpoCIT.Migrations
{
    ...
    [Migration("20221013044234_Change from I_1 format to I_a in RPEJ")]
    partial class ChangefromI_1formattoI_ainRPEJ
    {
            ...
            modelBuilder.Entity("ExpoCIT.Models.RPEI", b =>
                {
                    b.HasOne("ExpoCIT.Models.Proyecto", "Proyecto")
                        .WithOne("Rpei")
                        .HasForeignKey("ExpoCIT.Models.RPEI", "ProyectoId")
            ...
            modelBuilder.Entity("ExpoCIT.Models.RPEJ", b =>
                {
                    b.HasOne("ExpoCIT.Models.Proyecto", "Proyecto")
                        .WithOne("Rpej")
                        .HasForeignKey("ExpoCIT.Models.RPEJ", "ProyectoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpoCIT.Models.RTEEI", b =>
                {
                    b.HasOne("ExpoCIT.Models.Proyecto", "Proyecto")
                        .WithOne("Rteei")
                        .HasForeignKey("ExpoCIT.Models.RTEEI", "ProyectoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
